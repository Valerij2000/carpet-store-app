export function Icon({ name }: { name: "search" | "user" | "heart" | "cart" | "pin" | "delivery" }) {
  const paths = {
    ...
    delivery: <><path d="M3 6h11v10H3zM14 10h4l3 3v3h-7z" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" /><circle cx="7" cy="18" r="1.8" fill="none" stroke="currentColor" strokeWidth="1.7" /><circle cx="18" cy="18" r="1.8" fill="none" stroke="currentColor" strokeWidth="1.7" /></>,
  }[name];
